...
while True:
    ...
    if command == "quit":
        ...
        for foodImage in [
            "onigiri_order.png",
            "california_roll_order.png",
            "gunkan_maki_order.png",
            "salmon_roll_order.png",
            "shrimp_sushi_order.png",
            "unagi_roll_order.png",
            "dragon_roll_order.png",
            "combo_order.png",
        ]:
            numOrders = len(
                list(
                    pyautogui.locateAllOnScreen(
                        foodImage, region=[20 + winLeft, 40 + winTop, 580, 60]
                    )
                )
            )
            if numOrders > 0:
        ...
        if command == "2":  # handle ordering more rice
            ...
            if (
                pyautogui.locateOnScreen("cant_afford_rice.png", region=phoneRegion)
                != None
            ):
            ...
            if (
                pyautogui.locateOnScreen(
                    "cant_afford_" + command + ".png", region=phoneRegion
                )
                != None
            ):
