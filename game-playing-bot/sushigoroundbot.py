...
def getGameRegion():
    ...
    GAME_REGION = (
        ...
        640,
        480,
    )  # the game screen is always 640 x 480
...
def setupCoordinates():
    ...
    INGRED_COORDS = {
        SHRIMP: (GAME_REGION[0] + 40, GAME_REGION[1] + 335),
    ...
    ORDER_BUTTON_COORDS = {
        SHRIMP: (GAME_REGION[0] + 496, GAME_REGION[1] + 222),
...
def navigateStartGameMenu():
    ...
    while (
        ...
        pos = pyautogui.locateCenterOnScreen(
            imPath("play_button.png"), region=GAME_REGION
        )
        if pos is not None:
            break
    ...
    # click on Continue
    pos = pyautogui.locateCenterOnScreen(
        imPath("continue_button.png"), region=GAME_REGION
    )
    pyautogui.click(pos, duration=0.25)
    ...
    while (
        True
    ):  # loop because it could be the yellow or red Skip button displayed at the moment.
        pos = pyautogui.locateCenterOnScreen(
            imPath("skip_button.png"), region=GAME_REGION
        )
        if pos is not None:
            break
    pyautogui.click(pos, duration=0.25)
...
def makeOrder(orderType):
    ...
    while (
        ...
        and pyautogui.locateOnScreen(
            ...
            region=(GAME_REGION[0] + 115, GAME_REGION[1] + 295, 220, 175),
        )
        is None
    ):
        time.sleep(0.1)
...
def findAndClickPlatesOnBelt():
    ...
    for color in ("pink", "blue", "red"):
        result = pyautogui.locateCenterOnScreen(
            ...
            region=(GAME_REGION[0] + 343, GAME_REGION[1] + 300, 50, 100),
        )
        if result is not None:
...
def orderIngredient(ingredient):
    ...
    if ingredient == RICE and ORDERING_COMPLETE[RICE] is None:
        ...
        if pyautogui.locateOnScreen(
            ...
            region=(GAME_REGION[0] + 498, GAME_REGION[1] + 242, 90, 75),
        ):
            logging.debug("Can't afford rice. Canceling.")
            pyautogui.click(
                GAME_REGION[0] + 585, GAME_REGION[1] + 335, duration=0.25
        ...
        if pyautogui.locateOnScreen(
            ...
            region=(GAME_REGION[0] + 446, GAME_REGION[1] + 187, 180, 180),
        ):
            logging.debug("Can't afford %s. Canceling." % (ingredient))
            pyautogui.click(
                GAME_REGION[0] + 597, GAME_REGION[1] + 337, duration=0.25
            )  # click cancel phone button
            return
    ...
    pyautogui.click(
        GAME_REGION[0] + 589, GAME_REGION[1] + 341
    )  # click cancel phone button
...
def checkForGameOver():
    ...
    result = pyautogui.locateOnScreen(
        imPath("you_win.png"),
        region=(GAME_REGION[0] + 188, GAME_REGION[1] + 94, 262, 60),
    )
    if result is not None:
    ...
    result = pyautogui.locateOnScreen(
        ...
        region=(GAME_REGION[0] + 167, GAME_REGION[1] + 133, 314, 39),
    )
    if result is not None:
