...
valid_chess_board = {'h1': 'Bking', 'c6': 'Wqueen', 'g2': 'Bbishop', 'h5': 'Bqueen', 'e3': 'Wking'}

invalid_kings = {'e8': 'Bking', 'd1': 'Wqueen', 'f8': 'Bbishop', 'e1': 'Wking', 'e3': 'Wking'}

invalid_pawns = {'a7': 'Bpawn', 'b7': 'Bpawn', 'c7': 'Bpawn', 'd7': 'Bpawn', 'e7': 'Bpawn', 'f7': 'Bpawn', 'g7': 'Bpawn', 'h7': 'Bpawn',
                 'h6': 'Bpawn'}

invalid_num_pieces = {'a2': 'Wpawn', 'b2': 'Wpawn', 'c2': 'Wpawn', 'd2': 'Wpawn', 'e2': 'Wpawn', 'f2': 'Wpawn', 'g2': 'Wpawn', 'h2': 'Wpawn',
                      'a1': 'Wrook', 'b1': 'Wknight', 'c1': 'Wbishop', 'd1': 'Wqueen', 'e1': 'Wking', 'f1': 'Wbishop', 'g1': 'Wknight', 'h1': 'Wrook',
                      'a3': 'Wrook'}

invalid_chess_coordinates = {'z9': 'Bqueen'}

invalid_piece_colours = {'h1': 'king', 'c6': 'queen', 'g2': 'bishop', 'h5': 'queen', 'e3': 'king'}
...
assert validate_chess_board(invalid_piece_colours) == False, 'Invalid piece colour evaluated to true'
assert validate_chess_board(invalid_chess_coordinates) == False, 'Invalid chess coordinates evaluated to true'
